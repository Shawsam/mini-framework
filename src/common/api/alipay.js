...
//===========================================================================
//code获取uuid
export const autCodeGetUuid = (code)=>{
    getStorage();
    const url = preUrl_ali + '/autCodeGetUuid';
    const param = { ..._param, autCode:code };
    return httpPromise.get(url, param);
}

//token生成
export const getToken = ({uuid, userId})=>{
    const url = preUrl_ali + '/getToken';
    const param = { ..._param, uuid, userId };
    return httpPromise.get(url, param);
}
...
export const judgeToken = ()=>{
    getStorage();
    const url = preUrl_ali + '/judgeToken';
    const param = { ..._param, uuid, userId, token };
    return httpPromise.get(url, param);
}

//解密
export const encryptedData = (encryptedData,sign)=>{
    getStorage();
    const url = preUrl_ali + '/encryptedData';
    const param = { ..._param, encryptedData, sign };
    if(encryptedData) return httpPromise.get(url, param);
}

export const fetchUserInfoById = () => {
    getStorage();
    const url = preUrl_ali + '/member/userInfo';
    const param = { ..._param, uuid };
    return httpPromise.get(url, param);
}
...
export const fetchUserInfoByMobile = (mobile) => {
    getStorage();
    const url = preUrl_ali + '/member/userInfo';
    const param = {  ..._param, idType:5, amount:mobile, uuid }
    return httpPromise.get(url,param)
}
...
export const userRegister = ({mobile,gender,birth,shopId}) => {
    ...
    const param = { ..._param, name:nickName, acceptPic:avatarUrl, mobile, gender, birth, uuid, shopId };
...
export const userLogin = (mobile) => {
    getStorage();
    const url = preUrl_ali + '/member/login';
    const param = { ..._param, uuid, mobile };
    return httpPromise.post(url, param);
}

//支付宝开卡
export const openCard = (authCode, requestId, mobile)=>{
    getStorage();
    const url = preUrl_ali + '/openCard';
    const param = {  ..._param, authCode, requestId, uuid, token, mobile };
    console.log(param)
    return httpPromise.get(url, param);
}

//埋点 模板消息
export const addFormId = (formId, expiryTime, type)=>{
    getStorage();
    const url = preUrl_ali + '/templateMessage/addFormId';
    const param = {  ..._param, uuid, token, userId, formId, expiryTime, type  };
    return httpPromise.post(url, param);
}
...
export const editUserInfo = ({ gender, name, birth, pic, taskId }) => {
    ...
    const param = { ..._param, userId, gender, name, birth, pic, openid, token, taskId, cardNo };
...
export const receiveTask = ({taskId}) => {
    ...
    const param = { ..._param, userId, openid, token, cardNo, taskId };
    return httpPromise.post(url, param, true);
}
...
export const userVisit = ({equipment,path,lat,lng}) =>{
    ...
    const param = { ..._param, userId, openid, token, equipment, path, lng, lat };
    return httpPromise.post(url, param);
}
